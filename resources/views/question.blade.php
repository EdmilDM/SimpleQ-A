...
@section('content')
  ...
  @isset($question)
    ...
    <form class="needs-validation" novalidate action="/question/{{ $question->id }}/answer" method="POST"> 
    @csrf
        <div class="form-group mt-3 ">
            <textarea name="answer" class="form-control " id="questiontextarea" rows="3" placeholder="Answer the question!" required minlength="5"></textarea>
